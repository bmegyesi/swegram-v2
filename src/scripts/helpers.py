...
def visualise_text(text):
    ...
    for sent in text.sentences:
        ...
        sent_dict['tokens'] = [
            {**token.__dict__, 'highlight': None} for token in sent.tokens]
...
#     data['text_ids'] = [(t['fields']['text_id'], t['fields']
#                          ['filename']) for t in text_list]
#     selected_text_ids = []
...
#             if values:
#                 data['options'].append(
#                     {'value': value, 'label': label, 'children': values})
