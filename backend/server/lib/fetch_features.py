...
def get_features_for_items(
    ...
    for aspect in aspects:
        ...
        for feature_name, feature_data in _aspect_dict.items():
            feature_data["mean"] = mean([value for value in feature_data["mean"] if value != "" and value is not None])
            feature_data["median"] = median([value for value in feature_data["median"] if value !="" and value is not None])
