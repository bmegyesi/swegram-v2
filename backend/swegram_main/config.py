...
BASE_DIR = Path(os.environ.get("SWEGRAM_WORKSPACE", "/root"))
...
SWEGRAM_MAIN_BASE_DIR = Path(__file__).absolute().parent.parent
KELLY_DIR = SWEGRAM_MAIN_BASE_DIR.joinpath("swegram_main", "statistics", "kelly")
