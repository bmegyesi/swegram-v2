...
const orderBy = function(array, sortKey, reverse, sortMethod, sortBy) {
  ...
  const getKey = sortMethod ? null : function(value, index) {
    if (sortBy) {
      return lodashUnified.flatMap(lodashUnified.castArray(sortBy), (by) => {
    ...
    return [
      shared.isObject(value) ? sortKey ? lodashUnified.get(value, sortKey) : null : value
    ];
  };
...
const getTableOverflowTooltipProps = (props, innerText, row, column) => {
  ...
  const tooltipFormatterContent = shared.isFunction(column == null ? void 0 : column.tooltipFormatter) ? column.tooltipFormatter({
    row,
    column,
...
function createTablePopper(props, popperContent, row, column, trigger, table) {
  ...
  if ((exports.removePopper == null ? void 0 : exports.removePopper.trigger) === trigger) {
    const comp = (_a = exports.removePopper.vm) == null ? void 0 : _a.component;
    lodashUnified.merge(comp == null ? void 0 : comp.props, mergedProps);
  ...
  exports.removePopper = () => {
    ...
    const currentRemovePopper = exports.removePopper;
  ...
  exports.removePopper.trigger = trigger != null ? trigger : void 0;
